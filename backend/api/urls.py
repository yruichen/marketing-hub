...
from api.admin_console import (
    ...
    AdminProInviteDetailView,
    AdminProInviteListCreateView,
...
urlpatterns = [
    ...
    path('admin-console/pro-invites/', AdminProInviteListCreateView.as_view(), name='admin_console_pro_invites'),
    path('admin-console/pro-invites/<int:pk>/', AdminProInviteDetailView.as_view(), name='admin_console_pro_invite_detail'),
    path('admin-console/enterprise-requests/', AdminEnterpriseRequestListView.as_view(), name='admin_console_enterprise_requests'),
