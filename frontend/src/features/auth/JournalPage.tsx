    ...
    <div className="auth-page">
      <div className="auth-page__header">
        ...
        <div>
          ...
          <h2 className="auth-page__title">{mode === 'login' ? '登录工作台' : mode === 'register' ? '创建账号' : '重置密码'}</h2>
        </div>
      </div>
      ...
      <div className="auth-page__footer">
        <p><ShieldCheck className="h-3.5 w-3.5" /> 注册后按引导创建工作区并配置你的 AI Provider。</p>
      </div>
    </div>
  );
}
